...
then we'll extend that with the users API slice.
in short the apiSlice is gonna be the parent slice to our other API slices like userAPISlice...etc
*/
...
export const apiSlice = createApi({
  baseQuery,
  tagTypes: ['User'],//tagTypes are used to define the types of data that will be fetching from our API.
